...
for _ in range(60):
    ...
    raise RuntimeError("PostgreSQL 연결 실패: DB가 안 떠 있음")
...
CREATE TABLE IF NOT EXISTS users (
    ...
    email TEXT NOT NULL,
    current_village_id INTEGER REFERENCES village(village_id)
);
"""
...
REGION_DATA = {
    ...
    "경기도": [
        ...
        "의정부시","시흥시","파주시","김포시","광명시","광주시","군포시","오산시","이천시","안성시",
        "의왕시","하남시","여주시","양평군","동두천시","과천시","가평군","연천군","양주시","포천시"
    ],
    "강원특별자치도": [
...
try:
    ...
    print(f"✅ village 테이블에 {len(rows)}개 지역/시군구 등록 (중복은 자동 건너뜀)")
